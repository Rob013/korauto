-- Update keyset pagination functions to support extended sorting fields
-- This migration extends the RPC functions to handle year, mileage, make, and created_at sorting

-- Update cars_keyset_page function to support additional sort fields
