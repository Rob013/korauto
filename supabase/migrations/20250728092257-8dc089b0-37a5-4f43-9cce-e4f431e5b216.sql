-- Clean up all existing auto-sync cron jobs to prevent conflicts
...
-- Create index for better performance on archived cars
...
-- Create a function to trigger initial full sync (for manual use)
