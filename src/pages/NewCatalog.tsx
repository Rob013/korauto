...
const mockFiltersData = {
  ...
  fuelTypes: [
    { id: 'petrol', name: 'Petrol', count: 567 },
    { id: 'diesel', name: 'Diesel', count: 432 },
    { id: 'hybrid', name: 'Hybrid', count: 123 },
    { id: 'electric', name: 'Electric', count: 89 },
  ],
  transmissions: [
    { id: 'manual', name: 'Manual', count: 543 },
    { id: 'automatic', name: 'Automatic', count: 678 },
  ...
  bodyTypes: [
    ...
    { id: 'coupe', name: 'Coupe', count: 123 },
    { id: 'wagon', name: 'Wagon', count: 87 },
  ],
  colors: [
    { id: 'black', name: 'Black', count: 234 },
    { id: 'white', name: 'White', count: 198 },
    { id: 'silver', name: 'Silver', count: 156 },
    { id: 'gray', name: 'Gray', count: 134 },
    { id: 'blue', name: 'Blue', count: 98 },
    { id: 'red', name: 'Red', count: 76 },
  ],
  locations: [
    { id: 'seoul', name: 'Seoul', count: 456 },
    { id: 'busan', name: 'Busan', count: 234 },
    { id: 'incheon', name: 'Incheon', count: 123 },
    { id: 'daegu', name: 'Daegu', count: 98 },
  ],
