      ...
      <div className="container-responsive py-8 space-y-6">
        <Card className="shadow-md border-border/70">
          ...
          <CardContent className="space-y-4 text-sm leading-6 text-muted-foreground">
            <p>
              Nëse pas inspektimit në Kosovë automjeti rezulton me defekte në aksident ne pjesen e jashtme dhe brendshme motor, transmision apo manipulim kilometrazhi , shitësi mban përgjegjësi. Për pjesët harxhueshme nuk ofrohet garanci dhe nuk mbahet përgjegjësi. 
            </p>
