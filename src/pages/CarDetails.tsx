              ...
              <CardContent className="p-4 lg:p-6">
                ...
                {showDetailedInfo && (
                  <div className="space-y-6 animate-in slide-in-from-top-2 duration-300">
                    ...
                    {/* Comprehensive API Data Section - Enhanced for 193,306 cars sync */}
                    {(car.engine_size || car.max_power || car.acceleration || car.bid_count || car.grade || car.previous_owners) && (
                      <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
                        <h4 className="text-lg font-semibold text-foreground flex items-center gap-2">
                        ...
                        {(car.engine_size || car.max_power || car.acceleration || car.top_speed || car.fuel_consumption) && (
                          <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {car.engine_size && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Engine Size:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.engine_size}</span>
                                </div>
                              )}
                              {car.max_power && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Max Power:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.max_power}</span>
                                </div>
                              )}
                              {car.acceleration && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Acceleration:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.acceleration}</span>
                                </div>
                              )}
                              {car.top_speed && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Top Speed:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.top_speed}</span>
                                </div>
                              )}
                              {car.fuel_consumption && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Fuel Consumption:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.fuel_consumption}</span>
                                </div>
                              )}
                            </div>
                          </div>
                        ...
                        {/* Auction & Market Data */}
                        {(car.bid_count || car.watchers_count || car.grade || car.estimated_value) && (
                          <div className="space-y-2">
                            <h5 className="text-sm font-medium text-foreground flex items-center gap-2">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                              {car.bid_count !== undefined && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Bid Count:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.bid_count}</span>
                                </div>
                              )}
                              {car.watchers_count !== undefined && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Watchers:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.watchers_count}</span>
                                </div>
                              )}
                              {car.grade && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                              ...
                              {car.estimated_value && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  ...
                                  <span className="text-sm font-medium text-muted-foreground">€{car.estimated_value.toLocaleString()}</span>
                                </div>
                              )}
                            </div>
                          </div>
                        ...
                        {(car.previous_owners || car.service_history || car.accident_history) && (
                          <div className="space-y-2">
                            <h5 className="text-sm font-medium text-foreground flex items-center gap-2">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                              {car.previous_owners && (
                                <div className="flex items-center justify-between p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground">Previous Owners:</span>
                                  <span className="text-sm font-medium text-muted-foreground">{car.previous_owners}</span>
                                </div>
                              )}
                              {car.service_history && (
                                <div className="p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground font-medium">Service History:</span>
                                  <p className="text-sm text-muted-foreground mt-1">{car.service_history}</p>
                                </div>
                              )}
                              {car.accident_history && (
                                <div className="p-3 bg-card border border-border rounded-lg">
                                  <span className="text-sm text-foreground font-medium">Accident History:</span>
                                  <p className="text-sm text-muted-foreground mt-1">{car.accident_history}</p>
                                </div>
                              )}
                            </div>
                          </div>
                        ...
                        {car.features && (
                          <div className="space-y-2">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(typeof car.features === 'string' ? JSON.parse(car.features) : car.features).map((feature: string, index: number) => (
                                ...
                                <div className="ml-2 flex gap-1">
                                  {car.details?.inspect_outer && (
                                    <div
                                      ...
                                      title="Visual inspection data available"
                                    />
                                  )}
                                  {(car.details?.inspect?.inner ||
                                    car.details?.insurance) && (
                                    <div
                                      ...
                                      title="Technical inspection data available"
                                    />
                                  )}
                                  {car.insurance_v2?.accidents && (
                                    <div
                                      className="w-2 h-2 bg-red-400 rounded-full"
                                      title="Accident history available"
                                    />
                                  )}
                                </div>
                              )}
