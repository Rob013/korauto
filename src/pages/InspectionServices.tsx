        ...
        <div className="container-responsive">
          ...
          <div className="max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button size="lg" variant="secondary" className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg btn-press-effect shadow-[var(--shadow-md)] hover:shadow-[var(--shadow-lg)]" onClick={() => navigate('/garancioni')}>
