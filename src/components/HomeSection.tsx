...
const HomeSection = () => {
  return <section id="home" className="min-h-[70vh] flex items-center justify-center bg-background pt-2 pb-2 relative">
      <div className="container-responsive text-center">
        <div className="max-w-4xl mx-auto">
          {/* Logo on Homepage */}
          <div className="mb-3">
            <div className="w-40 h-40 sm:w-48 sm:h-48 md:w-52 md:h-52 mx-auto flex items-center justify-center mb-2">
              <img 
          ...
          <p className="text-base md:text-lg mb-5 text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center items-center mb-6">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2.5 text-base" onClick={() => document.getElementById('cars')?.scrollIntoView({
            behavior: 'smooth'
          })}>
              Shfleto Makinat
            </Button>
            <Button variant="outline" size="lg" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground px-6 py-2.5 text-base transition-colors" onClick={() => window.location.href = '/inspections'}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-xl mx-auto mt-6">
            <div className="text-center">
              ...
              <div className="text-xs text-muted-foreground">Makina të Shitura në Kosovë</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center col-span-2 md:col-span-1">
              ...
              <div className="text-xs text-muted-foreground">Mbështetje</div>
            </div>
          </div>
        </div>
      </div>
